...
Back-end for advanced authorization with registration, login and getting users from database according to the user JWT token with small front integration.
